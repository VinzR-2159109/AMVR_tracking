...
class FeatureBasedAROverlay:
    def __init__(self, video_source=0, src_img_path='edm_image.png'):
        ...
        self.src_keypoints, self.src_descriptors = self.orb.detectAndCompute(self.src_img, None)
    ...
    def run(self):
        ...
        while True:
            ...
            frame_keypoints, frame_descriptors = self.orb.detectAndCompute(frame, None)
